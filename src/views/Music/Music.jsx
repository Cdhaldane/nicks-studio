...
import { MusicAlbumSchema, BreadcrumbSchema } from "../../components/SEO/StructuredData";
      ...
      {albums.length > 0 && (
        <>
          ...
          {currentSong && (
            <div className="spotify-embed-container">
              <iframe
                ...
                src={`https://open.spotify.com/embed/album/${currentSong.id}?utm_source=generator&theme=0`}
                width="100%"
                height="600"
                frameBorder="0"
          ...
          {!currentSong && albums[0] && (
            <div className="spotify-embed-container">
              <p className="spotify-embed-hint">Select an album above to listen</p>
              <iframe
                title={`Listen to ${albums[0].name}`}
